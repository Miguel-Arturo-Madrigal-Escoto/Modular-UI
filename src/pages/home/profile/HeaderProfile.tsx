  ...
  return (
    <div className="bg-white rounded-lg shadow-xl pb-8">
        {/* <div x-data="{openSettings: false} "className="absolute right-12 mt-4 rounded">
            ...
            <div x-show="openSettings" onClick={ () => "openSettings = false"} className="bg-white absolute right-0 w-40 py-2 mt-1 border border-gray-200 shadow-2xl" style={{display: "none"}}>
