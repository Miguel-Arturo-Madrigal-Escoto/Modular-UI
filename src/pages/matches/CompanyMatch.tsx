                ...
                <div className="bg-white border border-white shadow-lg  rounded-3xl p-4 m-4">
                    <div className="flex-none sm:flex">
                        <div className=" relative w-40 h-40   sm:mb-0 mb-3">
                            <img src={ user.image || defaultImageProfile } alt="Imagen del match (user)" className="w-40 h-40 object-cover rounded-2xl" />
                        </div>
                        <div className="flex-auto sm:ml-5 justify-evenly">
                                ...
                                <div className="flex items-center">
                                    <div className="flex flex-col">
                                        ...
                                        <div className="flex-auto text-gray-500 my-1">
                                            <span className="mr-3 ">{ positions.find(p => p.id === user.position)?.display }</span>
                            ...
                            <div className="flex flex-col items-start">
                                ...
                                <div className="flex-auto text-gray-500 my-1">
                                    <span className="mr-3 capitalize">{ user.about }</span>
                                </div>
                            </div>
