                ...
                <div className="bg-white border border-white shadow-lg  rounded-3xl p-4 m-4">
                    <div className="flex-none sm:flex">
                        <div className=" relative h-32 w-32   sm:mb-0 mb-3">
                            <img src={ company.image || defaultImageProfile } alt="Imagen del match (company)" className=" w-32 h-32 object-cover rounded-2xl" />
                        </div>
                        <div className="flex-auto sm:ml-5 justify-evenly">
                            <div className="flex items-center justify-between sm:mt-2">
                                <div className="flex items-center">
                                    <div className="flex flex-col">
                                        <div className="w-full flex-none text-lg text-gray-800 font-bold leading-none">{ company.name }</div>
                                        <div className="flex-auto text-gray-500 my-1">
                                            <span className="mr-3 ">{ sectors.find(s => s.id === company.sector)?.display }</span><span className="mr-3 border-r border-gray-200  max-h-0"></span><span>{ company.location }</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div className="flex flex-row items-center">
                                <div className="flex-auto text-gray-500 my-1">
                                    <span className="mr-3 ">{ company.about }</span>
                                </div>
                            </div>
